---
name: kratos-layout-best-practices
description: Use when designing, scaffolding, reviewing, or refactoring Go-Kratos services, especially when enforcing domain-homomorphic module directories across biz/data/service and keeping SQL, repo, usecase, and handler aligned by business domain.
---
