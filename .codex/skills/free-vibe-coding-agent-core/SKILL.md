---
name: free-vibe-coding-agent-core
description: Use when handling any request in the free-vibe-coding repository to act as a skill-routing proxy, classify task intent, and force the correct downstream skill selection before implementation.
---
...
示例：
- `ROUTE: new-module-development -> business-domain-expert + kratos-layout-best-practices`
- `KNOWLEDGE_GATE: fail (missing business domains, missing core models)`
- `ROUTE: kratos-module-refactor -> business-domain-expert + kratos-layout-best-practices`
