---
name: console-react-admin-guardrails
description: Use when working on the console-react template's React, TypeScript, Ant Design, Tailwind, or scaffold structure.
---
...
**REQUIRED SUB-SKILL:** Use `superpowers:react-best-practices` for any React component work, refactor, or performance-sensitive change.
